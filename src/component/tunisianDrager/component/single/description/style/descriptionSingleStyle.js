...
const DescriptionSingleStyle = (
    {data,type,id,typeThinks,indexParent,itemsData,characters,
     ...
     const [description_text_color,setDescriptionTextColor] = useState("")
     const [description_hover_color,setDescriptionHoverColor] = useState("")
...
export default DescriptionSingleStyle
