...
import "./stepperfinish.css"
const SteperFinish = () =>{
    return(
        <>
        <div style={{display:"flex"}}>
        <div className="bodyFinish" >
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 800 800" style={{enableBackground: 'new 0 0 800 800'}} xmlSpace="preserve">
        ...
        <h4 style={{marginTop:"-40%"}}>Hope u Enjoyed 😉
 </h4>
        </div>
        </div>
